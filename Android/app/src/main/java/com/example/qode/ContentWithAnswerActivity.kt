...
class ContentWithAnswerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        answerDataList.add(AnswerData("2018년 카카오가 카카오톡 메시징 서버에 Kotlin을 사용해 본 결과, 코드량이 비약적으로 감소하고 생산성이 대폭 향상되었다고 한다.", "오카카", "0", "4"))
        answerDataList.add(AnswerData("장황했던 Java와 비교하면 눈물날 정도로 간결한 문법을 제공한다. 간결한 문법을 제공하면서도 런타임 오버헤드가 거의 없다.", "네이버", "4", "3"))
        answerDataList.add(AnswerData("예외처리를 강제하지 않는다. JSONObject를 만들 때 눈물이 난다...", "오바마", "0", " -10"))
