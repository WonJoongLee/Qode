...
class AnswerAdapter(private val context: Context) : RecyclerView.Adapter<AnswerAdapter.AnswerViewHolder>() {
    ...
    class AnswerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(answerData: AnswerData, pos : Int, context:Context) {
            ...
            var commentClicked = false // comment 클릭 여부 확인 위한 변수. 근데 다른 방법으로 클릭 여부를 판단해서 지금은 쓸 당장은 없음.
